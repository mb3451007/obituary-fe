  ...
  return (
    ...
    >
      ...
      <div className="mt-[20px] tabletUserAcc:mt-[17px] mobileUserAcc:mt-[24px] w-full flex flex-wrap gap-[11px] tabletUserAcc:gap-[9px] mobileUserAcc:gap-[9px] ">
        <div
          className="relative  gradient-border-wrapper w-[234px] h-[76px] p-[2px] rounded-[8px]
        ...
        >
          ...
          <Link
          href={"/memorypage"}
            className="flex flex-col justify-between items-center bg-[#e9f1e8] w-full h-full rounded-[8px] pt-[12px] pb-[16px]
        ...
        <div
          className="relative  gradient-border-wrapper2 w-[234px] h-[76px] p-[2px] rounded-[8px]
        mobileUserAcc:w-[160px] mobileUserAcc:h-[73px]
        "
        >
          <div
            className="flex flex-col justify-between items-center bg-[#ffffff] w-full h-full rounded-[8px] pt-[12px] pb-[16px]
          mobileUserAcc:py-[6px]
          "
          >
            <div className="mobileUserAcc:text-center">
