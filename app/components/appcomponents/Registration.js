...
const Registration = () => {
  ...
  return (
    <div
      ...
      bg-cover bg-center w-full desktop:mt-[92.02px] mobile:mt-[72px] tablet:mt-[79px] flex justify-end items-center"
    >
      ...
      <div className="flex flex-col desktop:mx-16 tablet:mx-16">
        <div
          ...
          className="w-[360px] mobile:w-full flex justify-between mobile:justify-between items-center my-[30px] mobile:w-[310px] h-[43px] z-40"
        >
          <div
            link
       ...
       bg-white desktop:backdrop-blur tablet:backdrop-blur rounded-2xl border-[2px] border-[#FFFFFF] desktop:shadow-lg tablet:shadow-lg mobile:border-[0px] z-40"
        ...
        <div
          ...
          style={{ cursor: "pointer" }}
          className="w-[360px] mobile:w-full flex justify-end items-center mt-[30px] mobile:w-[310px] h-[43px] z-40"
        >
          <div
            link
            className="border-[1px] border-[#FFFFFF] rounded-[8px] shadow-custom-light-dark bg-transparent"
