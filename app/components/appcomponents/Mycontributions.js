        ...
        {isSkupnoOpen && (
          <div className="hidden mobileUserAcc:flex flex-row  mobileUserAcc:mt-[50px] gap-x-[13px]">
            <div className="flex flex-col gap-y-4">
              <GradientPurple num={"9"} text={"Žalna knjiga"} />
              <GradientPurple num={"6"} text={"Izreki sožalja"} />
              <GradientPurple num={"0"} text={"Posvetila"} isFor={"Gray"} />
              <GradientPurple num={"0"} text={"Dodane slike"} isFor={"Gray"} />
              <GradientPurple num={"28"} text={"Dnevne sveče"} />
            </div>

            <div className="flex flex-col gap-y-4">
              <GradientBlue num={"2"} text={"Moji Skrbniki"} />
              ...
              {tableData.map((row, index) => (
                <tr key={index}>
                  ...
                  <td className="p-4 border-t border-b border-r rounded-r border-[#A1B1D4]">
                    <Image alt="item" src={row.status} width={30} height={30} />
                  </td>
                </tr>
              ))}
            </tbody>
