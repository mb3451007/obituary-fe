...
const Indispensable = () => {
    ...
    const containerArray = [
        {
            ...
            discription: "Neprestano avtomatsko osveževanje osmrtnic in pogrebov v vašem kraju. Še več, poslali vam bomo kodo, ki jo lahko vaši programerji vstavijo v vašo obstoječo spletno stran in tudi tam bo osveževanje avtomatsko. En vnos osmrtnice za vse."
        },
        {
            id: 2,
            title: "Prihranek časa",
            discription: "Vnos nove osmrtnice s pogrebom vzame 2 minuti časa in prihrani v povprečju skoraj pol ure časa. Preračunajte koliko časa boste prihranili tedensko zaradi popolne informacije, ki je v pomoč uporabnikom."
        },
        {
            id: 3,
            title: "Žalujoči vam bodo hvaležni ",
            discription: "Vse koristne informacije bodo imeli na enem mestu, vključno z vašimi podatki in kontakti. Manj bo potrebe po klicanju, naknadnem preverjanju, po drobnih, a za njih pomembnih  vprašanjih."
        },
        {
            id: 4,
            title: "Nič dela kasneje s spletno stranjo",
            discription: "Ne, kasneje vam ne bo treba skrbeti za vašo spletno stran! Potrebnih je zgolj teh 20 minut, da vstavite potrebne podatke in slike in to je vse. Seveda, v kolikor boste želeli, lahko stran kadarkoli dopolnite in dodajate nove informacije, ne bo pa to potrebno. Za osveževanje vaše strani z najbolj relevantnimi podatki za uporabnike, je dovolj zgolj ažurno dodajanje osmrtnic in časa pogrebov, kar pa je v vašem interesu, ker vam prihrani čas. "
    ...
    return (
        <div className="relative w-full h-auto flex justify-center items-center">
            <div className="flex relative  max-w-[1920px] w-full  bg-no-repeat
             h-auto justify-center items-center tablet:items-start mobile:items-start mx-auto">
                ...
                <div className="absolute max-w-[1548px] tablet:mt-[43px] mobile:mt-[29px] tablet:max-w-[622px] mobile:max-w-[322px] tablet:h-[831px] h-[860px] tablet:mb-[263px] mobile:h-[1215px] w-full flex justify-end items-center">
                    <div className="h-full w-auto desktop:bg-white tablet:backdrop-blur mobile:backdrop-blur mobile:bg-gradient-to-r mobile:from-[#FFFFFF] mobile:to-[#FFFFFF30] mobile:border mobile:rounded-lg flex justify-center items-center
