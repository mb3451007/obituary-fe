...
const FrequentlyAskedQuestionView = ({ from }) => {
  ...
  return (
    <div className={`overflow-hidden flex items-center max-w-[1920px]  tablet:max-w-[600px] mobile:max-w-[400px] w-full mx-auto `}>
      <div className=
        {`h-full max-w-[1920px] mx-auto w-full flex py-[65px] desktop:py-[105px] tablet:py-[75px] ${from == "7" || from == "8" ? null : " mobile:bg-white tablet:bg-white "}  justify-center overflow-hidden `}>
        <div className="h-full  mx-auto max-w-[906px] px-5 w-full flex flex-col items-start tablet:items-center mobile:items-center">
          <div className="flex mobile:flex-col w-full justify-between ">
            ...
            {from == "7" || from == "8" ? null : <div className="self-end">
              <Link
                href={"/obituarylist"}
