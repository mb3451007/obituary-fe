            ...
            <div className="h-full w-full relative">
              ...
              <div className="absolute h-full overflow-auto  z-20 mobileUserAcc:bg-[#F1F5F8] flex flex-row justify-center gap-x-[30px] left-[0px] right-[0px]  ">
                ...
                <div className="w-[314px] flex flex-col  mt-[165px] mobileUserAcc:hidden ">
                  ...
                  {isButtonHide ? (
                    <React.Fragment>
                      <div className="w-[314] h-[58px] mt-[10px] py-[2px] px-[2px] rounded-[10px] shadow-custom-light-dark-box-image bg-gradient-to-b from-[rgba(13,148,232,0.05)] to-[rgba(24,100,163,0.05)]"></div>
                    ...
                    <React.Fragment>
                      ...
                      <div className="mt-[10px]">
                        <ButtonLightGreen
                          placeholderText={"OTTO VON bISMARCK"}
                        />
                      </div>
                    </React.Fragment>
                  )}
